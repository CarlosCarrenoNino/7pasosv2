<?php
    ...
    class Modelo_grafico
    {
        ...
        function TraerDatosGraficosConexionXsupervisor()
        {
            ...
            JOIN TBL_ACONTROLLOG_BOT_VTR ON REPLACE(REPLACE(TBL_AREG_ASESOR_VTR.REG_CCEDULA_ASESOR, char(13), ''), char(10), '') = REPLACE(REPLACE(TBL_ACONTROLLOG_BOT_VTR.CON_CDETALLE1, char(13), ''), char(10), '')
            ...
            GROUP BY TBL_AREG_ASESOR_VTR.REG_CJEFE_INMEDIATO ORDER BY ACTIVOS DESC, INACTIVOS DESC";
