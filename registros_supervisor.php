...
<html lang="es">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-black">
            <!-- Navbar Brand-->
            <img src="vtricono.png" alt="icono vtr"><a class="navbar-brand ps-3" href="registros_supervisor.php">Supervisores 7 Pasos</a>
            <!-- Sidebar Toggle-->
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="registros_supervisor.php"><i class="fas fa-bars"></i></button>
            <!-- Navbar Search-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav"><br>
                            ...
                            <div class="sb-sidenav-menu-heading">MENÚ registros de supervisores</div>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <h5 id="nuevo1" style="color:black;">Nuevo Supervisor</h5>
                                        <form action="Enviar_registro_Supervisor.php" method="POST" id="">
                                            <div class="row mb-3">       
                                                <div class="col-md-3">
