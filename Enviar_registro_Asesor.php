...
if(isset($_POST['enviar'])){
    ...
    $UsuarioAndes=($_POST['UsuarioAndes']);
    ...
    $query="INSERT INTO TBL_AREG_ASESOR_VTR(REG_NID_SUPERVISOR, REG_CUSUARIO_ASESOR, REG_CNOMBRE_ASESOR, REG_CCEDULA_ASESOR, REG_CCLIENTE_ASESOR, 
    REG_COPERACION_ASESOR,REG_CCARGO, REG_CJEFE_INMEDIATO, REG_DETALLE_0, REG_DETALLE_1, REG_DETALLE_2, REG_DETALLE_3,REG_DETALLE_4) 
    VALUES('$IdJefe','$Usuario', '$Nombre', '$Cedula', '$Cliente', '$Operacion', '$Cargo', '$Jefe',
    '$Cordi', '$UsuarioAndes', '$Segmento', '$fechaHoy', '$horaHoy')";
    ...
    window.location.href="registros_asesor.php"
    </script>';


    /* header("location:registros_asesor.php"); */
