                    ...
                    <div class="sb-sidenav-menu">
                        ...
                        <a href="index.php"><button class="btn btn-dark bg-black form-control blod" >Voz</button></a> 
                            ...
                            <button class="btn btn-dark bg-black form-control blod" id="Consultar_fecha1" name="Consultar_fecha1" onclick="Consultar2()">Consultar</button> <br>
                             -->
                            <button class="btn btn-dark bg-black form-control blod" onclick="Actualizar3()" onclick="TotalLlamadas()">Actualizar</button>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                    <div class="card mb-4">
                                        <div class="card-header bg-black">
                                            <i class="fas fa-chart-bar me-1"></i>
                                            Usuarios X Supervisor NO VOZ
                                        </div>
                                        <div class="card-body" id="conexionsupervisor1">
                                        <canvas id="conexionsupervisor" width="100%" height="20"></canvas>
                                        </div>
                                    </div>
                            </div>
              <!--               <div class="col-xl-6">
...
function CargarDatosGraficosConexion2()
    {
        ...
        $.ajax({
          ...
          if(resp.length>0)
          {
            ...
            CrearGrafico2(titulo, cantidad, 'bar', 'USUARIOS'+' : '+total+' / '+TotalCantidadUsuarios,'conectadoshoy');
    ...
    function CargarDatosGraficosConexionXsupervisor2()
    {
        ...
        $.ajax({
          ...
          if(resp.length>0)
          {
                ...
                CrearGraficoSupervisor2(titulo, total, cantidad, cantidad2, 'horizontalBar', 'TOTAL', 'CONECTADOS', 'DESCONECTADOS',  'conexionsupervisor');
    ...
    function CrearGraficoSupervisor2(titulo, total, cantidad, cantidad2, tipo, encabezado3, encabezado, encabezado2, id)
    {
        $("#"+id+"1").html('<canvas id="'+id+'" width="100%" height="40"></canvas>');
        var opt = {
        events: false,
...
function Actualizar3(){
    ...
    function CargarDatosGraficosConexion3()
        {
            $.ajax({
              ...
              if(resp.length>0)
              {
                ...
                //console.log('titulo: '+titulo[0])
                CrearGrafico3(titulo, cantidad, 'bar', 'USUARIOS'+' : '+total+' / '+TotalCantidadUsuarios,'conectadoshoy');
                /* document.getElementById("conectadoshoy").style.display = "block";
                document.getElementById("conexionsupervisor").style.display = "block";
                document.getElementById("llamadas").style.display = "block";  
                document.getElementById("desconectados").style.display = "block"; */
        ...
        function CargarDatosGraficosConexionXsupervisor3()
        {
            $.ajax({
              ...
              if(resp.length>0)
              {
                ...
                CrearGraficoSupervisor3(titulo, total, cantidad, cantidad2, 'horizontalBar', 'TOTAL', 'CONECTADOS', 'DESCONECTADOS',  'conexionsupervisor');
        ...
        function CargarDatosGraficosLlamadas3()
        {
            $.ajax({
              ...
              if(data.length>0)
              {
                ...
                //console.log("SumaTotal: "+SumaTotal);
                CrearGrafico3(titulo, cantidad, 'bar', 'RUT'+' : '+SumaTotal,'llamadas');
               /*document.getElementById("conectadoshoy").style.display = "block";
                document.getElementById("conexionsupervisor").style.display = "block";
                document.getElementById("llamadas").style.display = "block";
                document.getElementById("desconectados").style.display = "block"; */
    ...
    function CrearGraficoSupervisor3(titulo, total, cantidad, cantidad2, tipo, encabezado3, encabezado, encabezado2, id)
    {
        $("#"+id+"1").html('<canvas id="'+id+'" width="100%" height="40"></canvas>');
        var opt = {
        events: false,
