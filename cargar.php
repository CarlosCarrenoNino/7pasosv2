...
<head>
    ...
    <title>Cargar 7 Pasos VTR</title>
                                        ...
                                        <form action="#" method="POST" enctype="multipart/form-data">
                                            <div class="mb-3">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <input class="form-control Actulizar-card" type="text" id="ubicacion-guardar-file" name="ubicacion-guardar-file" value="7_Pasos_VTR/">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
