<?php
    ...
    class Modelo_grafico
    {
        ...
        function TraerDatosGraficos()
        {
            ...
            WHERE (CON_CESTADO_BOT='Inactivo') AND (CON_DFECREG_BOT='$fechaHoy') AND (TBL_AREG_ASESOR_VTR.REG_DETALLE_2='NO VOZ') 
            ...
            WHERE  CON_CESTADO_BOT='Inactivo' AND CON_DFECREG_BOT='$fechaHoy' 
