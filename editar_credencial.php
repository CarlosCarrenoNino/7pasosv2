                                            ...
                                            <div class="row mb-3">       
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <select class="form-control" style="border: 1px solid #000000; color:black; line-height: 1.25;" name="Segmento" id="Segmento1" type="text"  placeholder="Jefe Inmediato">
                                                        <option value="<?php echo $CRE_CDETALLE1; ?>"><?php echo $CRE_CDETALLE1; ?></option>
