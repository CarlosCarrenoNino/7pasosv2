<?php
    ...
    if(isset($_GET['REG_NID_ASESOR'])){
        ...
        $query = "SELECT * FROM TBL_AREG_ASESOR_VTR WHERE REG_NID_ASESOR = $id";
        $result= sqlsrv_query($conn, $query);
    
        if($row = sqlsrv_fetch_array($result)){
    
            
            $IDJEFE=$row['REG_NID_SUPERVISOR'];
            $USUARIO=$row['REG_CUSUARIO_ASESOR'];
            $NOMBRE=$row['REG_CNOMBRE_ASESOR'];
            $CEDULA=$row['REG_CCEDULA_ASESOR'];
            $OPERACIÓN=$row['REG_COPERACION_ASESOR'];
            $CARGO=$row['REG_CCARGO'];
            $JEFEINMEDIATO=$row['REG_CJEFE_INMEDIATO'];
            $CORDI=$row['REG_DETALLE_0'];
            $ANDES=$row['REG_DETALLE_1'];
            $REG_DETALLE_2=$row['REG_DETALLE_2'];
    ...
    if(isset($_POST['update'])){
        ...
        $CORDI = $_POST['Cordinador'];
        $ANDES = $_POST['UsuarioAndes'];
        $REG_DETALLE_2 = $_POST['Segmento'];
        
        
        
        $query = "UPDATE TBL_AREG_ASESOR_VTR SET REG_NID_SUPERVISOR='$IDJEFE', REG_CUSUARIO_ASESOR='$USUARIO1', REG_CNOMBRE_ASESOR='$NOMBRE', 
        REG_CCEDULA_ASESOR='$CEDULA', REG_COPERACION_ASESOR='$OPERACIÓN', REG_CCARGO='$CARGO', REG_CJEFE_INMEDIATO='$JEFEINMEDIATO', 
        REG_DETALLE_0='$CORDI', REG_DETALLE_1='$ANDES', REG_DETALLE_2='$REG_DETALLE_2', REG_DETALLE_3='$fechaHoy1', 
        REG_DETALLE_4='$HoraTotal' WHERE REG_NID_ASESOR='$id'";
...
<html lang="es">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-black">
            <!-- Navbar Brand-->
            <img src="vtricono.png" alt="icono vtr"><a class="navbar-brand ps-3" href="editar_asesor.php">Asesores 7 Pasos</a>
            <!-- Sidebar Toggle-->
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="editar_asesor.php"><i class="fas fa-bars"></i></button>
            <!-- Navbar Search-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav"><br>
                            ...
                            <div class="sb-sidenav-menu-heading">MENÚ actualizar Asesor</div>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <h5 id="nuevo1" style="color:black;">Actualizar Asesor</h5>
                                        
                                        
                                        <form action ="editar_asesor.php?REG_NID_ASESOR=<?php echo $_GET['REG_NID_ASESOR']; ?>" method = "POST">
                                            <div class="row mb-3">       
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" style="border: 1px solid #000000; color:black" name="UsuarioAndes" id="UsuarioAndes1" 
                                                        type="text"  placeholder="Usuario Andes" value="<?php echo $ANDES; ?>">
                                                        <label for="" style="color:black"><b>Usuario Andes</b></label>
                                            ...
                                            <div class="row mb-3">       
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <!-- <input class="form-control" style="border: 1px solid #000000; color:black" name="IdSupervisor" id="IdSupervisor1" 
                                                        type="text"  placeholder="Id Supervisor" value="<?php echo $IDJEFE; ?>">
                                                        <label for="" style="color:black"><b>Id Supervisor</b></label> -->
                                                        ...
                                                        <option value="<?php echo $IDJEFE; ?>"><?php echo $IDJEFE; ?></option>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <!-- <input class="form-control" style="border: 1px solid #000000; color:black" name="Cordinador" id="Cordinador1" 
                                                        type="text"  placeholder="Cordinador" value="<?php echo $CORDI; ?>">
                                                        <label for="" style="color:black"><b>Cordinador</b></label> -->
                                                        ...
                                                        <option value="<?php echo $CORDI; ?>"><?php echo $CORDI; ?></option>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        type="text"  placeholder="Segmento" value="<?php echo $REG_DETALLE_2; ?>">
                                                        ...
                                                        <option value="<?php echo $REG_DETALLE_2; ?>"><?php echo $REG_DETALLE_2; ?></option>
