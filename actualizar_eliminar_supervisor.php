...
<html lang="es">
    <head>
        ...
        <title>REGISTROS SUPERVISOR | BOT 7 PASOS</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-black">
            <!-- Navbar Brand-->
            <img src="vtricono.png" alt="icono vtr"><a class="navbar-brand ps-3" href="actualizar_eliminar_supervisor.php">Supervisores 7 Pasos</a>
            <!-- Sidebar Toggle-->
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="actualizar_eliminar_supervisor.php"><i class="fas fa-bars"></i></button>
            <!-- Navbar Search-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav"><br>
                            ...
                            <div class="sb-sidenav-menu-heading">MENÚ actualizar supervisores</div>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <h5 id="nuevo1" style="color:black;">Supervisores</h5>
                                        ...
                                        <div id="RecargarInTabla">
                                            <table id="table_id" class="display">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sql="SELECT * FROM TBL_AREG_SUPERVISOR_VTR";
                                                    ...
                                                    while($resultado=sqlsrv_fetch_array($row)){
                                                        ...
                                                        $IDsuper=$resultado['REG_NID_SUPERVISOR'];
                                                        $USUARIO=$resultado['REG_CUSUARIO_SUPERVISOR'];
                                                        $NOMBRE=$resultado['REG_CNOMBRE_SUPERVISOR'];
                                                        $CEDULA=$resultado['REG_CCEDULA_SUPERVISOR'];
                                                        $OPERACIÓN=$resultado['REG_COPERACION_SUPERVISOR'];
                                                        $CARGO=$resultado['REG_CCARGO'];
                                                        $JEFEINMEDIATO=$resultado['REG_CJEFE_INMEDIATO'];
                                                        $SEGMENTO=$resultado['REG_DETALLE_0'];

                                                        
                                                        
                                                        ?>
                                                                        <tr>
                                                                            <td style="color: black;"><?php echo $IDsuper;?></td>
                                                                            ...
                                                                            <td style="color: black;"><?php echo $SEGMENTO;?></td>
                                                                                ...
                                                                                <!-- <form action ="editar_credencial.php" method="POST"> -->
                                                                                            <td hidden="hidden"><input type="text" hidden="hidden" name="id_new" id="id_new1" value="<?php echo $resultado['REG_NID_SUPERVISOR']; ?>"></td>
                                                                                            <td hidden="hidden"><b><input type = "text" hidden="hidden" name ="estado" class="form-control" row="12" value="Cancelado"> </b></td>
                                                                                            <td>
                                                                                            <a href="delete_supervisor.php?REG_NID_SUPERVISOR=<?php echo $resultado['REG_NID_SUPERVISOR'] ?>" class="btn btn-dark" >
                                                                                            ...
                                                                                            <hr>
                                                                                            <a href="editar_supervisor.php?REG_NID_SUPERVISOR=<?php echo $resultado['REG_NID_SUPERVISOR'] ?>" class="btn btn-dark" >
