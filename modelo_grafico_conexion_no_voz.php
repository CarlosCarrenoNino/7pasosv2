<?php
    ...
    class Modelo_grafico
    {
        ...
        function TraerDatosGraficosConexionNoVoz()
        ...
        {   
            ...
            WHERE CON_DFECREG_BOT ='$fechaHoy' and  (CON_CESTADO_BOT = 'Activo' or CON_CESTADO_BOT = 'Inactivo') and REG_DETALLE_2= 'NO VOZ' group by CON_CESTADO_BOT,CON_DFECREG_BOT";
             */
            $sql = "SELECT 'Posiciones Estado ' + CON_CESTADO_BOT as ESTADO,count(CON_CNOMPC_BOT)as USUARIOS, CON_DFECREG_BOT FROM TBL_ACONTROLLOG_BOT_VTR 
